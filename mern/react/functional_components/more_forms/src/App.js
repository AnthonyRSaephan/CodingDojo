  ...
  return (
    <div className="App">
      <div className={style.input}>
        ...
        <p>{firstName.length < 2 && "First Name must be at least 2 characters"}</p>
        <br/>
      </div>
      ...
      <div className={style.input}>
        ...
        <p>{lastName.length < 2 && "Last Name must be at least 2 characters"}</p>
      </div>

      <div className={style.input}>
        <label htmlFor='email'>Email: </label>
        <input id='email' onChange={e => setEmail(e.target.value)}></input>
        <p>{email.length < 2 && "Email must be at least 2 characters"}</p>
      </div>

      <div className={style.input}>
        <label htmlFor='password'>Password: </label>
        <input id='password' onChange={e => setPassword(e.target.value)}></input>
        <p>{password.length < 8 && "Password must be at least 8 characters"}</p>
