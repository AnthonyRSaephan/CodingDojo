...
def number_of_military_branches():
    return 5
print(number_of_days_in_a_week_silicon_or_triangle_sides() + number_of_military_branches()) # 19 - Real Output: NameError: name 'number_of_days_in_a_week_silicon_or_triangle_sides' is not defined
...
def add(b,c):
    print(b+c) # 3 / 5
print(add(1,2) + add(2,3)) # 8 - Real Output: TypeError: unsupported operand type(s) for +: 'NoneType' and 'NoneType'
...
foobar()
print(b) # 300
# predicted order: 500 500 300 300
# real order: 500 500 300 500
